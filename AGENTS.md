...
- 当前稳定基准：**v2.8**。发布流水线于 2026-08-20 由维护者拍板执行（正式包由 `tools/build_release.py` 构建；Git 标签/Release 按发版门禁创建；Steam 工坊物品 `3767025052` 上传后回填 Manifest）。上一稳定基准 v2.7（Manifest `8538688044863448269`）已由 v2.8 覆盖。
