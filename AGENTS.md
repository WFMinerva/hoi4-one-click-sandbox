...
- 当前稳定基准：**v2.5**。维护者于2026-08-01确认 v2.5 实机回归通过（四份日志干净），正式包已构建并双重校验 SHA-256 一致；已推送 Git 标签 `v2.5` 并上传 Steam 工坊物品 `3767025052`。上一稳定基准 v2.4（Manifest `385131838239799795`）已由 v2.5 覆盖。
