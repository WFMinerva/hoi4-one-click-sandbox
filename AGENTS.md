...
- 当前稳定基准：**v2.4**。维护者于2026-08-01确认 v2.4-test1 实机回归通过（四份日志干净），正式包已构建并双重校验 SHA-256 一致；Git 标签与 Steam 工坊上传按发版门禁在维护者确认后完成。上一稳定基准 v2.3（Manifest `7223939852636260892`）仍挂在工坊物品 `3767025052`，待 v2.4 上传后更新。
