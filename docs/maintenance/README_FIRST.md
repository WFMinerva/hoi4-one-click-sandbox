...
- 上一稳定基准：v2.3（Steam工坊物品 `3767025052`，Manifest `7223939852636260892`）。
- 状态说明：本次发版按“先回归后正式化”流程推进，Git标签与工坊上传须在维护者确认后按 `docs/DEVELOPMENT.md` 完成；工坊物品ID不变（`3767025052`）。
...
- GitHub：正式源码位于 `main`；正式标签与无附件Release按发版门禁创建。
