...
> 本文已于2026-08-23按v2.9状态更新（Steam 工坊发布流水线执行中；不含 Git 远端推送）。
...
- 状态说明：维护者于 2026-08-23 明确要求将 v2.9 发布到既有 Steam 工坊物品 `3767025052` 并更新简介。正式包 SHA-256 `c0c1f4319944c98ffc2f658dc9c0024499ed4b83f1dff63401279a58951477e7`（34 文件）；标签提交与新 Manifest 在发布完成后回填。未获“推送”授权，不推 Git 远端。
