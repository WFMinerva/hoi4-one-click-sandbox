...
> 本文已于2026-08-23按v2.9状态更新（Steam 工坊发布完成；不含 Git 远端推送）。
...
- 状态说明：v2.9 正式包 SHA-256 `c0c1f4319944c98ffc2f658dc9c0024499ed4b83f1dff63401279a58951477e7`（34 文件）；本地标签 `v2.9` 指向 `1304b3f`；Steam 工坊物品 `3767025052` 已上传并更新简介（Manifest `3014636165754564201`，2026-08-23 22:44 日志 `Upload finished ... : OK`）。未获“推送”授权，Git 分支与标签未推远端。
